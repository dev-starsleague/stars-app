...
const s = StyleSheet.create({
  ...
  dayPillNum: { color: Colors.white, fontSize: Font.h3, fontWeight: '800' },
  ...
  campoNome: { color: Colors.white, fontSize: Font.body, fontWeight: '700' },
  ...
  slotText: { color: Colors.white, fontSize: Font.body, fontWeight: '700' },
  slotPrezzo: { color: Colors.slate, fontSize: Font.tiny, marginTop: 2 },
  slotTextOcc: { color: Colors.slate, fontSize: Font.tiny },
